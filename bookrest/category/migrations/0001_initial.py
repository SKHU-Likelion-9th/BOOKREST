...
=======
                ('pubdate', models.IntegerField(null=True, verbose_name='출판일')),
                ('stock', models.SmallIntegerField(default=5, verbose_name='재고')),
                ('department', models.CharField(choices=[('인문', '인문융합자율학부'), ('사회', '사회융합자율학부'), ('미디어', '미디어컨텐츠융합자율학부'), ('IT', 'IT융합자율학부')], max_length=30, verbose_name='수업개설학과')),
>>>>>>> 0569fd743ea496f38cbd6d2d41d97146096d2cd0
